...
// Expose React Table core primitives for compatibility
export { flexRender, type ColumnDef, type Column, type SortingState };
...
export const DataTableColumnHeader = <TData, TValue>({
  ...
  if (!canSort) {
    return (
      <span className="flex h-8 items-center text-xs font-semibold text-white/20 uppercase tracking-wider">
        {title}
      </span>
    );
  }
  ...
  return (
    <button
      className="flex h-8 items-center gap-2 px-0 text-xs font-semibold text-white/25 hover:text-white/60 bg-transparent border-none outline-none cursor-pointer sm:text-sm"
